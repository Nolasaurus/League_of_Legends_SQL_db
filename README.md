# League of Legends Meta-Strategy ("the meta") Tracking
Using Riot's API, this project will request the latest League of Legends match results once daily, storing the result in a SQL database. Dashboards featuring items or characters will auto-update using SQL queries.
